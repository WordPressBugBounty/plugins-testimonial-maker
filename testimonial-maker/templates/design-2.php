												...
												?>
																						<div class="tml-author-info"
																							...
																							<<?php echo esc_attr($tml_ds_name_tag); ?> class="testimonial-title tml-name"
																								style="font-size: 15px; font-weight: 700; margin: 0 0 3px 0; line-height: 1.4; align-self: <?php echo esc_attr($tml_title_flex); ?>; text-align: <?php echo esc_attr($tml_title_align); ?>;"><?php the_title(); ?></<?php echo esc_attr($tml_ds_name_tag); ?>>
